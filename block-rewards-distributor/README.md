...
A collection of binaries used to distribute block rewards to stakers and validators using Merkle tree-based distribution.

Guide: [Block reward distribution](./block_reward_distribution.md)
...
This system works with the [Rakurai Reward Distribution Program](../rakurai_docs/rakurai_programs/programs/reward_distribution/README.md) to distribute validator block rewards.
...
- `--reward-distribution-program-id`: The reward distribution program ID (Pubkey). See [deployed program IDs](../rakurai_docs/rakurai_programs/programs/reward_distribution/README.md#1-deployed-program-id) for mainnet and testnet addresses.
...
- `--reward-distribution-program-id`: The reward distribution program ID. See [deployed program IDs](../rakurai_docs/rakurai_programs/programs/reward_distribution/README.md#1-deployed-program-id) for mainnet and testnet addresses.
