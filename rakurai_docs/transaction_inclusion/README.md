...
| [Partner Tip and MevShare Revenue Settlement CLI](../rakurai_programs/cli/partner_reward_settlement.md) | Record MCA MevShare (post-pack), settle TCA/MCA revenue (`rakurai-partner-settle`); partners must hold MCA `record_authority` |
